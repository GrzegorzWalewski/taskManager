<div x-show="showEditForm" @click.away="showEditForm = false" id="drawer-form"
    class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800" tabindex="-1"
    ...
    <button type="button" @click="showEditForm=false" data-drawer-hide="drawer-form" aria-controls="drawer-form"
    ...
    <form class="mb-6" wire:submit="updateTask">
        <div class="mb-6">
            <input type="hidden" wire:model="taskId" required />
            <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Title')
                }}</label>
        ...
        <div class="mb-6">
            ...
            <textarea wire:model="description" id="description" rows="4"
                ...
                placeholder="{{ __('Write event description...') }}"></textarea>
            <div>
