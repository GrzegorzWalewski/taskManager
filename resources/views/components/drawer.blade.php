<div x-show="showSidenav" @click.away="showSidenav = false" id="drawer-form"
    ...
    <button type="button" @click="showSidenav=false" data-drawer-hide="drawer-form" aria-controls="drawer-form"
